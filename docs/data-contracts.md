...
The schemas use JSON Schema Draft 2020-12. Contract tests validate every committed sample, the built-in rule catalog, and analyzer-generated findings, incident, and analysis-summary files against these schemas.
